...
(function() {
  ...
  var SVActor5X = Number(parameters['actor5 Xpos'] || 696);
  var SVActor6X = Number(parameters['actor6 Xpos'] || 696);
  var SVActor7X = Number(parameters['actor7 Xpos'] || 696);
  var SVActor8X = Number(parameters['actor8 Xpos'] || 696);
  ...
  var SVActor5Y = Number(parameters['actor5 Ypos'] || 424);
  var SVActor6Y = Number(parameters['actor6 Ypos'] || 424);
  var SVActor7Y = Number(parameters['actor7 Ypos'] || 424);
  var SVActor8Y = Number(parameters['actor8 Ypos'] || 424);
  ...
  Sprite_Actor.prototype.setActorHome = function(index) {
	...
	case 6:
      x = $gameSystem.svActorX[6] || SVActor7X;
      y = $gameSystem.svActorY[6] || SVActor7Y;
    }
	case 7:
      x = $gameSystem.svActorX[7] || SVActor8X;
      y = $gameSystem.svActorY[7] || SVActor8Y;
    }
    // set position
    this.setHome(x, y);
  };
