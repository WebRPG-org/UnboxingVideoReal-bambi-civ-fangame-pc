...
BHell_Enemy_Suicide.prototype.initialize = function (x, y, image, params, parent, enemyList) {
     ...
     * @extends BHell.BHell_Enemy_Base
     */
    var BHell_Enemy_Orbiter2 = my.BHell_Enemy_Orbiter2 = function() {
        this.initialize.apply(this, arguments);
    };

    BHell_Enemy_Orbiter2.prototype = Object.create(BHell_Enemy_Base.prototype);
    BHell_Enemy_Orbiter2.prototype.constructor = BHell_Enemy_Orbiter2;

    BHell_Enemy_Orbiter2.prototype.initialize = function (x, y, image, params, parent, enemyList) {
    ...
    BHell_Enemy_Orbiter2.prototype.isOutsideMap = function () {
        return false;
    };
